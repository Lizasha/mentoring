...
public class TestRunner {
	...
	public void checkSubscribe() {
		...
		abstractPage.openLoginForm();
		loginAndRegistrationPage.inputLogin(invalidLogin).inputPassword(invalidPassword).clickOnSignIn();
		loginAndRegistrationPage.dragNDropEmailToEmailField().confirmSubscription();
		Assert.assertTrue(loginAndRegistrationPage.isSuccessfulSubscriptionMessageIsDisplayed(),
